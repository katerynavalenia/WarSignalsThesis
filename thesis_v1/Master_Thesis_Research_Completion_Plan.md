> **⚠️ ARCHIVED — superseded by `docs/v2/research_plan.md`.** This plan's
> forecasting question was tested and found null
> (see `docs/v1/supervisor_audit.md`). Kept for historical reference only.
