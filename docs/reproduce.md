...
python scripts/run_indicator_correlations.py  # Ch 3: correlations among the indicators
python scripts/run_shap_attribution.py   # Ch 4: where the fitted model looks
python scripts/plot_thesis_figures.py    # the remaining manuscript figures
```
