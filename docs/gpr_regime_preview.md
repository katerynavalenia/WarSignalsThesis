...
**Code:** `scripts/gpr_regime_preview.py` · **Tables:** `outputs/tables/gpr_*.csv`

The GDELT rebuild is the expensive part of the v3 plan, and
[`research_plan.md`](research_plan.md) §9 assigns probabilities to its
...
```bash
python scripts/gpr_regime_preview.py
```
