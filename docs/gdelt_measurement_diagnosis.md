...
`scripts/diagnose_gdelt_streams.py`)
...
## 4. What to build instead (summary; full spec in `research_plan.md` §5)
...
```bash
python scripts/diagnose_gdelt_streams.py --dates 20160301 20220301 20250301
```
