...
invocations, inside BigQuery's 1 TB/month free tier.
    ...
    cd thesis_v2 && python scripts/ingest_gdelt.py --preset full
    cd thesis_v2 && python scripts/ingest_gdelt.py --preset threat-act
    cd thesis_v2 && python scripts/ingest_gdelt.py --preset holdout

    # or an arbitrary span
    cd thesis_v2 && python scripts/ingest_gdelt.py --start 2015-02-18 --end 2015-12-31
